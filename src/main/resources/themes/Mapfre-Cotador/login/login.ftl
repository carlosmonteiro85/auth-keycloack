                    ...
                    <div class="container-fluid">
                        <div class="row centralize">
                            <div class="container-logo">
                                <img src="${url.resourcesPath}/fonts/logo_mapfre.png"
                            ...
                            <div class="col-sm-12 col-md-12">
                                <p class="instrucoesIndex">Para acessar o sistema, acesse o Portal de Cotadores
                                    Excelsior</p>
                            </div>
                            ...
                            <div class="btn-entrar">
                                <input tabindex="4" class="form-control bradseg-btn"
                                       ...
                                       style="background-color: #2C2B7C !important; color: white !important"/>
                            ...
                            <div class="col-sm-12 col-md-12">
                                <a class="instrucoesIndex"
                                   href="http://localhost:8080/Excelsior-CotadorEmpresarial/pages/login/esqueci_senha.jsf">Esqueci
                                    minha senha</a>
                            </div>
                            <div class="col-sm-12 col-md-12">
